...
<pre>
<code>
set logfile /opt/monit/logs/monit.log
...
In the same file, comment the lines below (because were not using pam and ssl): 
<pre>
<code>
...
And finally, change the following lines:
<pre>
<code>
